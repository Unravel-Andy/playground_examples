-- start query 1 in stream 0 using template query09.tpl and seed 1490436826
with bucket1q as (
  select
  count(*) ct,
...
from bucket1q, bucket2q, bucket3q, bucket4q, bucket5q;summary;

-- end query 1 in stream 0 using template query09.tpl
